...
bool MediaBuffer::pushVideoPackage(const unsigned char *d, const unsigned int len,
                                   const unsigned int ts, const unsigned int isIntra) {
    ...
    // 2. check if it is contained frame or new intra frame
    {
...
bool MediaBuffer::pushAudioPackage(const unsigned char *d, const unsigned int len,
